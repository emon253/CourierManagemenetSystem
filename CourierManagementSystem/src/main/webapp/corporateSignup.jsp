...
<head>
    ...
    <link rel="stylesheet" href="corporate account create.css">
...
<div class="container-fluid p-0">
  ...
  <div class="contain">
    <div class=" row contain2 mx-auto pr-5 pl-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 was-validated">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="uname" placeholder="Enter Corporate Name" name="uname" required>
          ...
          <div class="col-lg-5">
            ...
            <div class="form-group was-validated">
                ...
                <input type="password" class="form-control"  placeholder="Password" name="weigth" required>
            ...
            <div class="form-group was-validated">
                ...
                <input type="password" min="6" class="form-control"  placeholder="Confirm Password" name="weigth" required>
          ...
          <div class="col-lg-5 mx-auto was-validated">
            ...
            <div class="form-group">
                <label for="pwd">Corporate ID</label>
                <input type="text" class="form-control"  placeholder="Corporate ID" name="weigth" required>
      ...
      <div class="col-12">
          <p>By Creating an account you are accepting our <a href="#">terms and condition.</a></p>
      </div>
